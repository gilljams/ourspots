...
// Import all specialized block editors from individual files
...
// Main block editor dispatcher + text block editor
// Routes to specialized editors for each block type; handles text blocks inline
function BlockEditor({ block, onUpdate, onRemove, onMove, index, total, saving, locationIndexOffset = 0 }) {
  ...
  // --- Text block editor (default case) ---
...
// Re-export all specialized editors for backward compatibility
export {
  FullscreenTextEditor,
  ContactBlockEditor,
  LocationBlockEditor,
