    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      {website && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-10 h-10 rounded-lg bg-white/5 hover:bg-purple-500/20 text-purple-400 hover:text-purple-300 transition-all"
