  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      {phone && (
        <a
          href={`tel:${phoneClean}`}
          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-green-500/20 text-gray-300 hover:text-green-400 transition-all group"
        >
      ...
      {website && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-purple-500/20 text-gray-300 hover:text-purple-400 transition-all group"
        >
          ...
          <span className="text-sm truncate max-w-[180px]">{website.replace(/^https?:\/\//, '')}</span>
        </a>
      )}
    </div>
  );
